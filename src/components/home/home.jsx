      ...
      <div className="row public-section-bg">
        ...
        <div className="col-lg-3 col-md-6 col-sm-12 grid-margin">
          <div className="card">
            <div className="card-body">
              ...
              <h4 className="mb-0">
                {eligibleClaimPercentage ? eligibleClaimPercentage : 0} (LXC)
              </h4>
            </div>
          </div>
        </div>
        ...
        <div className="col-lg-3 col-md-6 col-sm-12 grid-margin">
          <div className="card">
            <div className="card-body">
              <h6>Partner ID</h6>
              <h4 className="mb-0">{partnerID ? partnerID : 0} (LXC)</h4>
            </div>
          </div>
        </div>
        ...
        <div className="col-lg-3 col-md-6 col-sm-12 grid-margin">
          <div className="card">
            <div className="card-body">
              <h6>User ID</h6>
              <h4 className="mb-0">{udId ? udId : 0} (LXC)</h4>
            </div>
          </div>
        </div>
